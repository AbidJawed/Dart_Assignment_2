...
void main() {
  Map<String, dynamic> world = {
    'Pakistan': {'capitalCity': 'Islamabad', 'currency': 'PKR'},
    'India': {'capitalCity': 'New Delhi', 'currency': 'INR'}
  };

  String country = 'Pakistan';
  print('$country CapitalCity is ${world[country]['capitalCity']}, $country Currency is ${world[country]['currency']}');
}
